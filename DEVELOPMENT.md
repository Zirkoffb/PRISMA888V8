...
```bash
git remote add encore encore://prisma888-electoral-intelligence-platform-dd42
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/prisma888-electoral-intelligence-platform-dd42/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/prisma888-electoral-intelligence-platform-dd42/settings/integrations/github)
